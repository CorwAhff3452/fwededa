...
PORT=53484
UUID=c7d29f72-040c-447a-a8a1-83c5bd1bacf7
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/CorwAhff3452/
fwededa /main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/CorwAhff3452/
fwededa /main/etc/xray.json
